...
//  obrigatório ter ID, ou enviado ou logado.
...
// echo '<pre>';
// var_dump('ID:'.$id);
// var_dump('userInfo ID: '.$userInfo->id);
// exit;
                ...
                <div class="profile-info m-20 row">
                    ...
                    <div class="profile-info-data row">
                        <div class="profile-info-item m-width-20">
                            <div class="profile-info-item-n">-1 <?php // count($user->followers);?></div>
                            <div class="profile-info-item-s">Seguidores</div>
                        </div>
                        <div class="profile-info-item m-width-20">
                            <div class="profile-info-item-n">-1 <?php // count($user->following);?></div>
                            <div class="profile-info-item-s">Seguindo</div>
                        </div>
                        <div class="profile-info-item m-width-20">
                            <div class="profile-info-item-n">-1 <?php // count($user->photos);?></div>
