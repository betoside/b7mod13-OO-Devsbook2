...
class UserRelationDaoMysql implements UserRelationDAO {
    ...
    public function getFollowing($id){
        ...
        $sql = $this->pdo->prepare("SELECT * FROM userRelations WHERE user_from = :user_from");
    ...
    public function isFollowing($id1, $id2){
        $sql = $this->pdo->prepare("SELECT user_from 
        FROM userRelations WHERE user_from = :user_from AND user_to = :user_to");
